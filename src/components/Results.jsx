    ...
    <div id='results' className={classes.results}>
      <section id='stats' className={classes.statsContainer}>
        <div className={classes.stats}>
          <h2>{title}</h2>
          <div className={classes.barchart} aria-label='Quiz results summary'>
            {resultData.map((res) => {
              return (
                <div key={res.name} className={classes.resultItem}>
                  ...
                  <div className={classes.barContainer}>
                    <div
                      ...
                      aria-label={`${res.name}: ${res.percentage}`}
                      role='img'
                    ></div>
                  </div>
                </div>
        ...
        <Button className={classes.restartBtn} handleClick={restartQuiz}>
          Restart
        </Button>
      </section>
      <section className={classes.resultAnswers} id='result-answers'>
        {children}
      </section>
    </div>
  );
